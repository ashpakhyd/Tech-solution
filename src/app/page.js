    ...
    <div className="container safe-area pb-20">
        ...
        <div className="gradient-card p-6 mb-6">
          <div className="flex justify-between items-start">
            <div className="flex-1">
              ...
              <Link href="/work-report" className="bg-white text-red-600 px-6 py-2 rounded-full font-semibold text-sm inline-block">
                View Details
              </Link>
            </div>
      ...
      <div className="px-6">
        ...
        <div className="space-y-4 mb-6">
          {(searchQuery ? filteredTickets : tickets?.filter(t => t.status !== 'COMPLETED').slice(0, 3))?.map((ticket) => (
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <span className={`px-2 py-1 text-xs rounded-full ${ticket.status === 'ASSIGNED' ? 'bg-yellow-100 text-yellow-800' :
                  ...
                  <div className="text-right">
                    ...
                    <p className={`text-xs font-medium ${ticket.priority === 'HIGH' ? 'text-red-600' :
